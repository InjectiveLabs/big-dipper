...
export default class AccountDetails extends Component{
    ...
    render(){
        ...
        if (this.state.loading){
            ...
            return <div id="account">
                <Helmet>
                    <title>Account Details of {this.state.address} on Cosmos | Injective Chain</title>
                    <meta name="description" content={"Account Details of "+this.state.address+" on Cosmos"} />
                </Helmet>
                <Row>
