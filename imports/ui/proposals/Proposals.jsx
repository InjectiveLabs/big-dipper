...
export default class Proposals extends Component{
    ...
    render() {
        return <div>
            <Helmet>
                <title>Governance Proposals on Cosmos | Injective Chain</title>
                <meta name="description" content="Cosmos incorporates on-chain governance. Come to see how on-chain governance can be achieved on Injective Chain." />
            </Helmet>
            <Row>
